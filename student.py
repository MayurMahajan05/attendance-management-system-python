...
class Student:
    ...
    def __init__(self, root):
        ...
        img_left_path = os.path.join(os.path.dirname(__file__), "college_images", "AdobeStock_303989091.jpeg")
        ...
        # Class Division
        studentDivision_label = Label(class_student_frame, text="Class Division:", font=("times new roman", 13, "bold"), bg="white")
        ...
        img_right_path = os.path.join(os.path.dirname(__file__), "college_images", "chat_people.jpg")
        ...
        # Added all 15 columns to match your DB screenshot
        ...
        for col in (
            ...
            "roll", "gender", "dob", "email", "phone", "address", "teacher"
        ):
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                if update > 0:
                    ...
                    query = """
                    UPDATE student
                    SET Dep=%s, Course=%s, Year=%s, Semester=%s, Name=%s,
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                while True:
                    ...
                    cropped_img = face_cropped(my_frame)
                ...
                messagebox.showinfo(
                    "Result",
                    "Generating data sets completed successfully!"
                )
